...
public class HistoryActivity extends ConnectedActivity {
  ...
  private List<SampleData> rawDataList;
  ...
  public void getHistoryData(long startTime, long endTime) {
    ...
    Single.create((SingleOnSubscribe<List<SampleData>>) emitter -> {
      List<SampleData> source = DatabaseManager.getInstance()
          .getDataDAO()
      ...
      emitter.onSuccess(source);
        ...
        .subscribe(new SingleObserver<List<SampleData>>() {
          @Override
          ...
          @Override
          public void onSuccess(List<SampleData> data) {
  ...
  private void showEcgViewList(List<SampleData> dataList) {
